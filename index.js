...
const getData = async () => {
    try {
        ...
        const rating = await page.waitForSelector("#kp-wp-tab-overview > div:nth-child(32) > div > div > div:nth-child(2) > div > div > div > div > div > div.jYcvae.kY5Gde")
        await rating.screenshot({path:'screenshot.png'})
